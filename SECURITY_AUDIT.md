...
- **Total Supply:** 10,000,000,000 TRUECASH
...
Node operators (Miners) earn a variable yield in TRUECASH for processing zero-gas transactions. This yield is strictly derived from the protocol's Treasury and network activity. TrueCash makes no guarantees of fixed APY or fiat value appreciation.
